...
const Project = ({technology, title, image, color, id, github, deployed, description}) => {
    ...
    return (
        ...
        >
            <div style={{ backgroundColor: color }} className="projectCard d-flex align-items-center justify-content-center p-5" onClick={handleOpenModal}>
                <div className="textWarp col-6 d-flex flex-column justify-content-center align-items-center m-5">
                    <p className="tech">
                        <em>{technology}</em>
                    </p>
